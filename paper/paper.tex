...
% FIXME(hermannloose): Wie soll der letzte Punkt überhaupt passieren?
...
% FIXME(hermannloose): Kurzer Absatz zur Nutzung mittels SMAC.
...
bei \texttt{ret}-Instruktionen.

% TODO(hermannloose): Ergebnisse.
