...
% FIXME(hermannloose): Zitate für die Angriffe.
...
% FIXME(hermannloose): Zitate für IRMs und SMAC?
...
Die Autoren bezeichnen diese Werte—zwischen 4\% und 56\%—bei einem Durchschnitt
von 21\% trotzdem als „bescheiden“ und nennen speziell 5\% für \texttt{gzip}
und 11\% für \texttt{gcc}.
